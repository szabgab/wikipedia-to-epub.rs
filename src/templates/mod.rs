...
fn is_handled_template_name(template: &str) -> bool {
    template.eq_ignore_ascii_case("Korean")
        ...
        || template.eq_ignore_ascii_case("cite video")
        || template.eq_ignore_ascii_case("cite tweet")
        || template.eq_ignore_ascii_case("cite constitution")
        || template.eq_ignore_ascii_case("cite biorxiv")
        || template.eq_ignore_ascii_case("harvard citation text")
        || template.eq_ignore_ascii_case("cite mw")
        || template.eq_ignore_ascii_case("term")
        || template.eq_ignore_ascii_case("defn")
        || template.eq_ignore_ascii_case("cquote")
        || template.eq_ignore_ascii_case("london gazette")
        || template.eq_ignore_ascii_case("us$")
        ...
        || template.eq_ignore_ascii_case("JSTOR")
        || template.eq_ignore_ascii_case("wsPSM")
        || template.eq_ignore_ascii_case("em")
        || template.eq_ignore_ascii_case("MathWorld")
        || template.eq_ignore_ascii_case("AS ref")
        || template.eq_ignore_ascii_case("OEIS2C")
        || template.eq_ignore_ascii_case("thinsp")
        || template.eq_ignore_ascii_case("dfn")
        || template.eq_ignore_ascii_case("subsup")
        || template.eq_ignore_ascii_case("abs")
        || template.eq_ignore_ascii_case("mono")
        || template.eq_ignore_ascii_case("pi")
        || template.eq_ignore_ascii_case("Springer")
        ...
        || template.eq_ignore_ascii_case("right")
        || template.eq_ignore_ascii_case("Cite peakbagger")
        || template.eq_ignore_ascii_case("wikibooks inline")
        || template.eq_ignore_ascii_case("wikibooks-inline")
        || template.eq_ignore_ascii_case("refh")
