...
* Observed Wikipedia navigation templates such as `{{History of Korea}}`, `{{Korea topics}}`, `{{East Asian topics}}`, `{{History of Asia}}`, `{{Portal bar}}`, `{{Portal}}`, `{{Commons category}}`, `{{Commons and category}}`, `{{Wikisource-inline}}`, `{{Sister project links}}`, `{{Seoul}}`, `{{Seoul weatherbox}}`, `{{Busan}}`, `{{Busan weatherbox}}`, `{{Navboxes}}`, `{{Library resources box}}`, `{{Authority control}}`, `{{Osaka}}`, `{{Osaka Prefecture}}`, `{{Kyoto}}`, `{{Kyoto Prefecture}}`, `{{Hungary articles}}`, `{{Geographic location}}`, `{{Budapest}}`, `{{Municipalities in Budapest Metropolitan Area}}`, `{{World Heritage Sites in Hungary}}`, `{{Regional capitals of Hungary}}`, `{{Principal cities of Hungary}}`, `{{European Capital of Sport}}`, `{{Hungary's most flowery settlements}}`, `{{List of European capitals by region}}`, and `{{Danube}}` are omitted
